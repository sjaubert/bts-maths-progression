% ============================================================
% Évaluation : Les Suites Numériques
...
\fancyhead[R]{{\small\color{uimmred}\textbf{MOD02 -- Éval}}}
...
{\color{white}\LARGE\bfseries Évaluation -- MOD02}\\[4pt]
...
\begin{consigne}
\textbf{Consignes.} Justifier la nature des suites et détailler tous les calculs. Les algorithmes peuvent être rédigés en langage naturel ou en Python.
\end{consigne}

\section{Généralités \hfill {\normalsize\color{uimmred}[C01]}}
\begin{exo}{Exercice 1}
\begin{enumerate}[label=\alph*)]
  \item Soit $u_n = 4n + 1$. Calculer $u_0$, $u_5$ et $u_{12}$.
  \item Soit $w_0 = 2$ et $w_{n+1} = 3w_n - 4$. Calculer $w_1$, $w_2$, $w_3$.
\end{enumerate}
\end{exo}
...
\begin{enumerate}[label=\alph*)]
  \item Exprimer sa valeur $V_n$ après $n$ années.
  \item Écrire un algorithme déterminant l'année où la valeur passe sous $15\,000\,$€.
  \item Donner cette année.
\end{enumerate}
\end{exo}
